...
class biography5 extends StatelessWidget {  
  @override  
    ...
    return Stack(
      ...
      child: Container(
        ...
        child:  Align(
          alignment: Alignment.center,
          child: Text(
            'Goddess Mayakka Mahatmya'.tr, style: GoogleFonts.inknutAntiqua(fontStyle: FontStyle.normal, fontSize: 21,
     ...
     Container(
       ...
       Container(
        ...
        decoration:  const BoxDecoration(
          image:  DecorationImage(
              image:  AssetImage("assets/biography5.jpg"),
               fit: BoxFit.fill,
          )
        )
       ),),
