...
class biography3 extends StatelessWidget {  
  @override  
    ...
    return Stack(
      ...
      child: Container(
        ...
        child:  Align(
          alignment: Alignment.center,
          child: Text(
            'Sri Mahalingaraya Life Biography'.tr, style: GoogleFonts.inknutAntiqua(fontStyle: FontStyle.normal, fontSize: 21,
     ...
     Container(
       ...
       Container(
        ...
        decoration:  const BoxDecoration(
          image:  DecorationImage(
              image:  AssetImage("assets/biography3.jpg"),
               fit: BoxFit.fill,
          )
        )
       ),),
