...
class biography4 extends StatelessWidget {  
  @override  
    ...
    return Stack(
      ...
      child: Container(
        ...
        child:  Align(
          alignment: Alignment.center,
          child: Text(
            'Sri Yenki-Zakaraya Brief Biography'.tr, style: GoogleFonts.inknutAntiqua(fontStyle: FontStyle.normal, fontSize: 21,
     ...
     Container(
       ...
       Container(
        ...
        decoration:  const BoxDecoration(
          image:  DecorationImage(
              image:  AssetImage("assets/biography4.jpg"),
               fit: BoxFit.fill,
          )
        )
       ),),
