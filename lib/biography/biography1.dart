...
class biography1 extends StatelessWidget {  
  @override  
    ...
    return Stack(
      ...
      child: Container(
        ...
        child:  Align(
          alignment: Alignment.center,
          child: Text(
            'Shri Jagatguru Revanasiddheshwar Biography'.tr, style: GoogleFonts.inknutAntiqua(fontStyle: FontStyle.normal, fontSize: 21,
